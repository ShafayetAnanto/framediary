...
const Watched = () => {
  ...
  const loadWatched = () => {
    try {
      ...
      console.log('Error loading watched:', error);
      setWatched([]);
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          ...
          <div className="text-center py-16">
            <Eye className="w-24 h-24 text-gray-600 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-gray-400 mb-2">No movies watched yet</h3>
            <p className="text-gray-500 mb-6">Start marking movies as watched!</p>
            <button
              onClick={() => navigate('/')}
          ...
          <div className="bg-gray-900 rounded-lg shadow-2xl max-w-md w-full p-6 border border-gray-800 animate-fade-in">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-white">Clear Entire Watched List?</h2>
              </div>
              <button
                onClick={cancelClear}
            ...
            <p className="text-gray-400 mb-6 ml-14">
              This will remove all {watched.length} movie{watched.length !== 1 ? 's' : ''} from your watched list. This action cannot be undone.
            </p>
